...
@section('content')
 <div class="container" style="margin-top: 50px; ">
         <form action="{{route('leave_type.store')}}" method="post" enctype="multipart/form-data" style="padding-top: 10px">
        @csrf
         ...
         <div class="row">
          ...
          <div class="col-md-5 {{ $errors->first('leave_type', 'has-error') }}">
               ...
               <input type="text" name="leave_type" placeholder="Enter Leave Type" class="form-control" style="font-size: 13px"> 
        ...
        <div class="col-md-5 {{ $errors->first('num_of_leave', 'has-error') }}">
            ...
            <input type="number" name="num_of_leave" placeholder="2" class="form-control" style="font-size: 13px">
