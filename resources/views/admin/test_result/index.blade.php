...
<?php
  ...
  ?>
   ...
   <form action="{{route('test_result.index')}}" method="get" accept-charset="utf-8" class="form-horizontal unicode" >
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-6">
                        @can('testresult-create')
                        <a class="btn btn-success unicode" href="{{route('test_result.create')}}" style="float: right;font-size: 13px"><i class="fas fa-plus"></i> Test Result</a>
                        @endcan
                         </div>
                    </div>
                </div>
