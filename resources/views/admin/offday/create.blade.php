...
@section('content')
 <div class="container" >
        <form action="{{route('offday.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('post')
       <div class="row">
        ...
        <div class="col-md-5 {{ $errors->first('name', 'has-error') }}">
           ...
           <input type="text" name="off_day_1" class="form-control" placeholder="01-01-2021" id="off_day_1">
        ...
        <div class="col-md-5 {{ $errors->first('name', 'has-error') }}">
           ...
           <input type="text" name="off_day_2" class="form-control" placeholder="01-01-2021" id="off_day_2">
        ...
        <div class="col-md-5 {{ $errors->first('name', 'has-error') }}">
           ...
           <input type="text" name="off_day_3" class="form-control" placeholder="01-01-2021" id="off_day_3">
        ...
        <div class="col-md-5 {{ $errors->first('name', 'has-error') }}">
           ...
           <input type="text" name="off_day_4" class="form-control" placeholder="01-01-2021" id="off_day_4">
